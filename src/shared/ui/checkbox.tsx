...
export const Checkbox = ({
    ...
    return (
        ...
        `}
            ...
            <label
                htmlFor={id}
                className={`flex items-center select-none ${disabled ? "cursor-not-allowed" : "cursor-pointer"
                    }`}
            >
                <span
                    className={`
            ...
            ${checked
                            ...
                            : `border-gray-300 bg-white ${currentVariant.hover}`
                        }
          `}
                >
                    {/* splash animation */}
            ...
            `}
                    ...
                    <svg
                        ...
                        style={{
                            ...
                            strokeDashoffset: checked ? "0px" : "16px",
