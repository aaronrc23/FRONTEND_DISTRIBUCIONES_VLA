...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(
    ({ className, variant = "default", onClick, ...props }: CardProps, ref) => {
        const variants = {
            default:
                "rounded-2xl border border-card-border bg-card shadow-card transition-shadow  hover:shadow-hover backdrop-blur-xl",
            elevated:
                "bg-card border border-card-border rounded-2xl p-5 shadow-card hover:shadow-hover  transition-shadow duration-300",
            ...
            glass:
                "bg-slate-800/40 border-card-border hover:border-emerald-500/50 hover:bg-slate-800/60",
